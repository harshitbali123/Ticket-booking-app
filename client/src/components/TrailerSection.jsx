...
const TrailerSection = () => {
  const [currentTrailer, setCurrentTrailer] = useState(dummyTrailers[1] || null)

  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
      
      <p className='text-lg font-medium text-gray-300 max-w-[960px]'>
        Trailers
      </p>
      ...
      <div className='relative mt-6'>
        ...
        {currentTrailer && (
          <div className="relative mx-auto aspect-video max-w-[840px] mb-8 rounded-xl">
            <img src={currentTrailer.image} alt="" />
          </div>
        )}
